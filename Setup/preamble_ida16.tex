...
% Openright : Åbner kapitler på lige sider.
...
\usepackage{steinmetz} 	%Phasors del 1
\usepackage{pict2e}		%Phasors del 2
...
\makeevenhead{Uni}{Gruppe C2-06}{}{\leftmark}				% Lige siders sidehoved (\makeevenhead{Navn}{Venstre}{Center}{Hoejre})
\makeoddhead{Uni}{\rightmark}{}{AAU}			% Ulige siders sidehoved (\makeoddhead{Navn}{Venstre}{Center}{Hoejre})
